...
/**
 * @see http://www.sojson.com/blog/70.html
 */
public class VerifyCodeUtils {
    ...
    public static void outputImage(int width, int height, OutputStream outputStream, String code) throws IOException {
        outputImage(width, height, outputStream, code, false);
    }
     ...
     * @throws IOException
     */
    private static void outputImage(int width, int height, OutputStream outputStream, String code, boolean needRotation)
            throws IOException {
